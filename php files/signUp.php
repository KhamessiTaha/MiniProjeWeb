...
if(isset($postdata) && !empty($postdata))
{
    ...
    if(isset($request->username) && isset($request->password) && isset($request->email_adress) && isset($request->phone_num)) {
        ...
        if(strlen($password) < 8){
            ...
            if($email_adressExistsResult->num_rows > 0){
                ...
                $sql1 = "INSERT INTO user (username,password,email_adress,phone_num) VALUES ('$username','$password','$email_adress','$phone_num')";
